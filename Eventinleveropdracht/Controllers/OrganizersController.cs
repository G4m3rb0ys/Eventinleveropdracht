...
namespace Eventinleveropdracht.Controllers
{
    public class OrganizersController : Controller
    {
        ...
        public OrganizersController(VoorbeeldDatabase context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("phone,Id,Name,Email,Username,Password,Role,Discriminator")] Organizer organizer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("phone,Id,Name,Email,Username,Password,Role,Discriminator")] Organizer organizer)
        {
            if (id != organizer.Id)
            {
                return NotFound();
